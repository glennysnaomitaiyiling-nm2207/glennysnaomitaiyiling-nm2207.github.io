...
// functions to that change the content of the html page, not executed yet; only executed when eventlistener detects event
...
//event listeners on the buttons that execute the functions when a click is detected
...
/* const dataObj = {
  ...
  datasets: [
    {   label: "Average Expenditure",
        ...
        borderWidth: 2,
        backgroundColor: "hsla(49,98%,72%,0.3)",
